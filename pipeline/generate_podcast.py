...
INTRO_SUBJECTS: dict[str, str] = {
    ...
    "social-anxiety": "feeling their pulse race at the thought of being around people",
    "procrastination-paralysis": "frozen in front of the thing they most need to do",
    "quarter-life-crisis": "in their twenties and quietly lost about what comes next",
    "midlife-crisis": "halfway through life and questioning all of it",
    "empty-nest": "standing in a house gone quiet after the children left",
    "aging-parents": "watching the people who raised them slowly grow frail",
    "sibling-conflict": "estranged from a brother or sister and grieving it",
    "losing-a-friendship": "watching a friendship fade without a single fight",
    "people-pleasing": "exhausted from saying yes and losing themselves in it",
    "perfectionism-trap": "held hostage by a standard no human could ever meet",
    "decision-paralysis": "frozen at a crossroads, unable to choose any path",
    "regret-over-past-choices": "kept awake by a choice they cannot take back",
    "fear-of-the-future": "filled with dread every time they think of tomorrow",
    "losing-motivation": "drained of the spark that used to pull them forward",
    "health-scare-fear": "waiting on test results and fearing the worst",
    "body-image-struggles": "at war with their own reflection",
    "addiction-recovery": "doing the daily, unglamorous work of staying free",
    "betrayal-trust-broken": "trying to trust again after someone they believed in lied",
}
